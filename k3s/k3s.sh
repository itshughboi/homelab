...
#Loadbalancer IP range // This is where the external IP to access the service comes from
lbrange=10.10.30.60-10.10.30.99

#ssh certificate name variable // private key for this server
certName=ansible
